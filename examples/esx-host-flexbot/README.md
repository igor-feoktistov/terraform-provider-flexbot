# Flexbot to build and manage ESXi hosts

This example demonstrates how to use `flexbot` Terraform provider to build and manage
VMware ESXi bare-metal hosts on FlexPOD.
